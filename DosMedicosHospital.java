...
public class DosMedicosHospital {
    ...
    static class RelojMundial extends Thread {
        ...
        List<Integer> Tiempos = leerTiemposDeAtencion("Pacientes_Dos_Medicos.txt");
        List<Paciente> listaPacientes = leerPacientesDesdeArchivo("Pacientes_Dos_Medicos.txt");
        ...
        public void run() {
            ...
            while (DosMedicosHospital.tiempoSimulado < 1320) {
                System.out.println("Tiempo simulado: " + DosMedicosHospital.tiempoSimulado);
                ...
                DosMedicosHospital.tiempoSimulado += 1;
            }
            DosMedicosHospital.simulacionActiva = false;
    ...
    static class Hilo_Medico extends Thread {
        ...
        @Override
        public void run() {
            while (DosMedicosHospital.simulacionActiva || !secretaria.isVacia()) {
                try {
                    if (Paciente_Con_Emergencia) {
                        ...
                        if (tiempoDeEmergencia == 0) {
                            ...
                            logAtenciones.add(pEmergencia.nombre + " - Emergencia | Llegó: " + pEmergencia.horaLlegada +
                                    " | Salió: " + DosMedicosHospital.tiempoSimulado + " | Espera: " + espera + " min");
                        ...
                        tiempoInicioEmergencia = DosMedicosHospital.tiempoSimulado;
                        ...
                        enfermeros.acquire();
                        paciente_en_Sala = true;
                        tiempoInicioAtencion = DosMedicosHospital.tiempoSimulado;
                        switch (p.area) {
    ...
    public static void generarReporte() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("Reporte_De_Hospital_De_Dos_Medicos.txt"))) {
